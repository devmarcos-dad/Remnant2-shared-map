-- MapSync LAN package (zero-config) — não edite nada para jogar na mesma rede
local Config = {
    ModName = "MapSync",
    Version = "0.5.2-poc",
    ...
    -- Sempre true: o bridge sobe sozinho (steam_bridge ou lan_bridge conforme Transport).
    ...
    -- Transport do pacote: "steam" | "lan" | "tcp". Não mude AutoStartBridge.
    Transport = "lan",
